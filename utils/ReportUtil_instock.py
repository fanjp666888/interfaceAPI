...
class ReportUtil():
    ...
    TR_TMPL = r"""
        ...
        <td style="vertical-align:middle; text-align:center" name="unmatched"> %(unmatched)s</td>
        </tr>
        """
    BOTTOM_TMPL = r"""
        </table>
    ...
    def generateReport(self,StartTime,Duration,searchresults):
        ...
        for searchresult in searchresults:
            ...
            tr += self.TR_TMPL % dict(id=search_id,kw=keyword,pagenum=pagenum,totalcount=totalcount,matchstatus=matchstatus,unmatched=unmatched)
        
        bottom = self.BOTTOM_TMPL
        with open("reports\\detailed_instock"+starttime+".html",'wb') as f:
